...
var G__10705 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__10705,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__10705;
}
});
...
var len__4531__auto___10710 = arguments.length;
var i__4532__auto___10711 = (0);
while(true){
if((i__4532__auto___10711 < len__4531__auto___10710)){
args__4534__auto__.push((arguments[i__4532__auto___10711]));

var G__10712 = (i__4532__auto___10711 + (1));
i__4532__auto___10711 = G__10712;
continue;
} else {
}
break;
...
/** @this {Function} */
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq10707){
...
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__10708,G__10709,seq10707__$2);
});
...
var file = cljs.core.get.call(null,map__10714__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__10714__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__10714__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__10714,map__10714__$1,file,line,column){
return (function (p1__10713_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__10713_SHARP_));
});})(map__10714,map__10714__$1,file,line,column))
...
var temp__5457__auto___10716 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___10716)){
var message_10717 = temp__5457__auto___10716;
cljs.core.println.call(null,message_10717);
} else {
}
...
var temp__5457__auto___10718 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___10718)){
var message_10719 = temp__5457__auto___10718;
cljs.core.println.call(null,message_10719);
} else {
}
...
var output_dir__$1 = (function (){var G__10720 = output_dir;
if(!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/"))){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__10720),"/"].join('');
} else {
return G__10720;
}
})();
...
var G__10722 = exception.stack;
var G__10722__$1 = (((G__10722 == null))?null:clojure.string.split_lines.call(null,G__10722));
var G__10722__$2 = (((G__10722__$1 == null))?null:cljs.core.get.call(null,G__10722__$1,depth));
if((G__10722__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__10722__$2);
}
} else {
...
var vec__10723 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__10723,(0),null);
var column = cljs.core.nth.call(null,vec__10723,(1),null);
var vec__10726 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__10726,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__10726,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__10726,(2),null);
...
var m__$1 = (function (){var G__10729 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
...
var G__10733 = (function (){var G__10732 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__10732);
} else {
return G__10732;
}
})();
...
return cljs.core.vary_meta.call(null,G__10734,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
}catch (e10735){var e = e10735;
var G__10736 = e;
var G__10736__$1 = (((G__10736 instanceof cljs.core.Keyword))?G__10736.fqn:null);
switch (G__10736__$1) {
...
var vec__10738 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__10738,(0),null);
var types = vec__10738;
...
return cljs.core.map.call(null,(function (p__10741){
var vec__10742 = p__10741;
var ns = cljs.core.nth.call(null,vec__10742,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__10742,(1),null);
return ((function (vec__10742,ns,vars__$1){
return (function (){
...
var G__10745 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__10745,G__10745__$1,env,once_fixtures,each_fixtures,vec__10742,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__10745,G__10745__$1,env,once_fixtures,each_fixtures,vec__10742,ns,vars__$1){
return (function (){
var seq__10746 = cljs.core.seq.call(null,vars__$1);
var chunk__10747 = null;
var count__10748 = (0);
var i__10749 = (0);
while(true){
if((i__10749 < count__10748)){
var v = cljs.core._nth.call(null,chunk__10747,i__10749);
var temp__5457__auto___10751 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___10751)){
var t_10752 = temp__5457__auto___10751;
each_fixture_fn.call(null,((function (seq__10746,chunk__10747,count__10748,i__10749,t_10752,temp__5457__auto___10751,v,each_fixture_fn,G__10745,G__10745__$1,env,once_fixtures,each_fixtures,vec__10742,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_10752)));
});})(seq__10746,chunk__10747,count__10748,i__10749,t_10752,temp__5457__auto___10751,v,each_fixture_fn,G__10745,G__10745__$1,env,once_fixtures,each_fixtures,vec__10742,ns,vars__$1))
);
} else {
}


var G__10753 = seq__10746;
var G__10754 = chunk__10747;
var G__10755 = count__10748;
var G__10756 = (i__10749 + (1));
seq__10746 = G__10753;
chunk__10747 = G__10754;
count__10748 = G__10755;
i__10749 = G__10756;
continue;
} else {
var temp__5457__auto__ = cljs.core.seq.call(null,seq__10746);
if(temp__5457__auto__){
var seq__10746__$1 = temp__5457__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__10746__$1)){
var c__4351__auto__ = cljs.core.chunk_first.call(null,seq__10746__$1);
var G__10757 = cljs.core.chunk_rest.call(null,seq__10746__$1);
var G__10758 = c__4351__auto__;
var G__10759 = cljs.core.count.call(null,c__4351__auto__);
var G__10760 = (0);
seq__10746 = G__10757;
chunk__10747 = G__10758;
count__10748 = G__10759;
i__10749 = G__10760;
continue;
} else {
var v = cljs.core.first.call(null,seq__10746__$1);
var temp__5457__auto___10761__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___10761__$1)){
var t_10762 = temp__5457__auto___10761__$1;
each_fixture_fn.call(null,((function (seq__10746,chunk__10747,count__10748,i__10749,t_10762,temp__5457__auto___10761__$1,v,seq__10746__$1,temp__5457__auto__,each_fixture_fn,G__10745,G__10745__$1,env,once_fixtures,each_fixtures,vec__10742,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_10762)));
});})(seq__10746,chunk__10747,count__10748,i__10749,t_10762,temp__5457__auto___10761__$1,v,seq__10746__$1,temp__5457__auto__,each_fixture_fn,G__10745,G__10745__$1,env,once_fixtures,each_fixtures,vec__10742,ns,vars__$1))
);
} else {
}


var G__10763 = cljs.core.next.call(null,seq__10746__$1);
var G__10764 = null;
var G__10765 = (0);
var G__10766 = (0);
seq__10746 = G__10763;
chunk__10747 = G__10764;
count__10748 = G__10765;
i__10749 = G__10766;
continue;
}
} else {
...
});})(each_fixture_fn,G__10745,G__10745__$1,env,once_fixtures,each_fixtures,vec__10742,ns,vars__$1))
);
});})(each_fixture_fn,G__10745,G__10745__$1,env,once_fixtures,each_fixtures,vec__10742,ns,vars__$1))
], null);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__10745__$1)].join('')));

}
})());
});
;})(vec__10742,ns,vars__$1))
