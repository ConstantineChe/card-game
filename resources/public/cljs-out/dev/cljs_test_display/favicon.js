...
return cljs.core.map.call(null,(function (p1__12092_SHARP_){
return html_coll.item(p1__12092_SHARP_);
...
return cljs.core._EQ_.call(null,"icon",p1__12093_SHARP_);
...
var ctx_12094 = cvs.getContext("2d");
ctx_12094.fillStyle = color;

ctx_12094.fillRect((0),(0),size,size);
