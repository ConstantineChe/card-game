...
var G__13359 = devtools.prefs.pref.call(null,v);
v = G__13359;
continue;
} else {
return v;
...
}catch (e13362){var _e__12254__auto__ = e13362;
return false;
}})();
...
}catch (e13366){var _e__12254__auto__ = e13366;
return false;
}})();
...
}catch (e13368){var _e__12254__auto__ = e13368;
return false;
}}
}
});
...
var vec__13370 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__13370,(0),null);
var name = cljs.core.nth.call(null,vec__13370,(1),null);
...
return cljs.core.some.call(null,(function (p1__13373_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__13373_SHARP_);
}),template);
});
