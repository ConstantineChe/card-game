...
args__4534__auto__.push((arguments[i__4532__auto___13414]));
...
/** @this {Function} */
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq13410){
...
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__13411,G__13412,seq13410__$2);
});
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__13416_SHARP_){
return !((cljs.core.meta.call(null,p1__13416_SHARP_) == null));
})))){
...
var markup_db = cljs.core.get.call(null,map__13417__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e13421){var _e__12254__auto__ = e13421;
return false;
}})();
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
...
}catch (e13423){var _e__12254__auto__ = e13423;
return false;
}}
})())){
...
var _STAR_current_state_STAR_13425 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__13426 = opts;
...
var markup_db = cljs.core.get.call(null,map__13426__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_13425;
}});
...
;
var temp__5455__auto___13430 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5455__auto___13430)){
var managed_print_level_13431 = temp__5455__auto___13430;
var _STAR_print_level_STAR_13429_13432 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_13431;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_13429_13432,managed_print_level_13431,temp__5455__auto___13430,writer,opts,job_fn){
return (function (p1__13428_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__13428_SHARP_,null);
});})(_STAR_print_level_STAR_13429_13432,managed_print_level_13431,temp__5455__auto___13430,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_13429_13432;
}} else {
job_fn.call(null);
}
