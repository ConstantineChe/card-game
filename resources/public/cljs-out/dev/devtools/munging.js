...
var o12427 = temp__5455__auto__;
var temp__5455__auto____$1 = (o12427["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o12428 = temp__5455__auto____$1;
return (o12428["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__12247__auto__ = f;
return (o__12247__auto__["toString"]).call(o__12247__auto__);
} else {
return "";
}
}catch (e12429){var _ = e12429;
return "";
}});
...
try{var o__12247__auto___12431 = t;
(o__12247__auto___12431["cljs$lang$ctorPrWriter"]).call(o__12247__auto___12431,t,writer);
}catch (e12430){var __12432 = e12430;
}
...
var char_code = (function (){var o__12247__auto__ = (new String(char$));
return (o__12247__auto__["charCodeAt"]).call(o__12247__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__12247__auto__ = String;
return (o__12247__auto__["fromCharCode"]).call(o__12247__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__12433 = num_code;
switch (G__12433) {
case (1):
return (185);
...
var o__12247__auto__ = String;
return (o__12247__auto__["fromCharCode"]).call(o__12247__auto__,superscript_code);
});
/**
...
}catch (e12435){var _e__12254__auto__ = e12435;
return false;
}})())){
...
var vec__12436 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__12436,(0),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var o12439 = temp__5455__auto__;
var temp__5455__auto____$1 = (o12439["dependencies_"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o12440 = temp__5455__auto____$1;
return (o12440["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4531__auto___12447 = arguments.length;
var i__4532__auto___12448 = (0);
while(true){
if((i__4532__auto___12448 < len__4531__auto___12447)){
args__4534__auto__.push((arguments[i__4532__auto___12448]));

var G__12449 = (i__4532__auto___12448 + (1));
i__4532__auto___12448 = G__12449;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__12443){
var vec__12444 = p__12443;
var ns_detector = cljs.core.nth.call(null,vec__12444,(0),null);
...
var G__12450 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__12451 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__12450;
remaining_tokens = G__12451;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq12441){
var G__12442 = cljs.core.first.call(null,seq12441);
var seq12441__$1 = cljs.core.next.call(null,seq12441);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__12442,seq12441__$1);
});
...
var vec__12455 = cljs.core.split_with.call(null,(function (p1__12454_SHARP_){
return cljs.core.not_EQ_.call(null,p1__12454_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__12455,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__12455,(1),null);
...
var vec__12458 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__12458,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__12458,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__12461 = cljs.core.rest.call(null,remaining_tokens);
var G__12462 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__12461;
name_tokens = G__12462;
continue;
} else {
...
var vec__12465 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__12465,(0),null);
var arity = cljs.core.nth.call(null,vec__12465,(1),null);
var vec__12468 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__12468,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__12468,(1),null);
var vec__12471 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__12471,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__12471,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__12471,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__12471,(3),null);
...
var munged_ns = cljs.core.nth.call(null,vec__12477,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__12477,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__12477,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__12477,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__12477,(4),null);
var arity = cljs.core.nth.call(null,vec__12477,(5),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__12481 = temp__5455__auto__;
var munged_name = cljs.core.nth.call(null,vec__12481,(0),null);
var args = cljs.core.nth.call(null,vec__12481,(1),null);
var vec__12484 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__12484,(0),null);
var name = cljs.core.nth.call(null,vec__12484,(1),null);
...
var G__12487 = (arity + (1));
var G__12488 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__12489){
var vec__12490 = p__12489;
var arity = cljs.core.nth.call(null,vec__12490,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__12490,(1),null);
...
return cljs.core.get.call(null,arities,p1__12493_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__12494_SHARP_);
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__12497){
var vec__12498 = p__12497;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__12498,(0),null);
...
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__12496,seq12495__$1);
});
...
var G__12504 = arg;
var G__12504__$1 = (((G__12504 instanceof cljs.core.Keyword))?G__12504.fqn:null);
switch (G__12504__$1) {
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__12506__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__12506__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__12506__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__12506__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__12507 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__12507,(0),null);
var fn_name = cljs.core.nth.call(null,vec__12507,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__12507,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__12507,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__12507,(4),null);
var arity = cljs.core.nth.call(null,vec__12507,(5),null);
...
var o__12247__auto__ = f;
return (o__12247__auto__["getBasis"]).call(o__12247__auto__);
});
/**
...
}catch (e12511){var _e__12254__auto__ = e12511;
...
var G__12512 = (obj[cljs.core.first.call(null,path)]);
var G__12513 = cljs.core.rest.call(null,path);
obj = G__12512;
path = G__12513;
continue;
} else {
...
return (function (accum,p__12514){
var vec__12515 = p__12514;
var bit = cljs.core.nth.call(null,vec__12515,(0),null);
var protocol = cljs.core.nth.call(null,vec__12515,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__12518){
var vec__12519 = p__12518;
var ns = cljs.core.nth.call(null,vec__12519,(0),null);
var name = cljs.core.nth.call(null,vec__12519,(1),null);
var selector = cljs.core.nth.call(null,vec__12519,(2),null);
...
return (function (p__12523){
var vec__12524 = p__12523;
var munged_name = cljs.core.nth.call(null,vec__12524,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__12524,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__12524,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__12522_SHARP_){
return (obj[cljs.core.first.call(null,p1__12522_SHARP_)]);
});})(name,sorted_matches,vec__12524,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
