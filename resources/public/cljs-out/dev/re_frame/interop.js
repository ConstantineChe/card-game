...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var pred__14138 = cljs.core.instance_QMARK_;
var expr__14139 = reactive_val;
if(cljs.core.truth_(pred__14138.call(null,reagent.ratom.RAtom,expr__14139))){
return "ra";
} else {
if(cljs.core.truth_(pred__14138.call(null,reagent.ratom.RCursor,expr__14139))){
return "rc";
} else {
if(cljs.core.truth_(pred__14138.call(null,reagent.ratom.Reaction,expr__14139))){
return "rx";
} else {
if(cljs.core.truth_(pred__14138.call(null,reagent.ratom.Track,expr__14139))){
return "tr";
} else {
return "other";
}
