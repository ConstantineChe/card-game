...
if((i < len)){
var k = (ks[i]);
var G__11723 = cljs.core.assoc.call(null,m,cljs.core.keyword.call(null,k),(o[k]));
var G__11724 = (i + (1));
m = G__11723;
i = G__11724;
continue;
...
return ((cljs.core.fn_QMARK_.call(null,c)) && (!(((function (){var G__11726 = c;
var G__11726__$1 = (((G__11726 == null))?null:G__11726.prototype);
if((G__11726__$1 == null)){
return null;
} else {
return (G__11726__$1["reagentRender"]);
}
})() == null))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_.call(null,c)) && (!(((function (){var G__11728 = c;
var G__11728__$1 = (((G__11728 == null))?null:G__11728.prototype);
if((G__11728__$1 == null)){
return null;
} else {
return (G__11728__$1["render"]);
}
})() == null))));
});
...
while (G__11732__i < G__11732__a.length) {G__11732__a[G__11732__i] = arguments[G__11732__i + 0]; ++G__11732__i;}
  args = new cljs.core.IndexedSeq(G__11732__a,0,null);
} 
...
var args = cljs.core.seq(arglist__11733);
...
var _STAR_current_component_STAR_11735 = reagent.impl.component._STAR_current_component_STAR_;
...
}finally {reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR_11735;
}});
...
return ((function (G__11736,G__11736__$1){
...
var c = this;
var G__11741_11743 = (c["cljsRatom"]);
if((G__11741_11743 == null)){
} else {
reagent.ratom.dispose_BANG_.call(null,G__11741_11743);
}
...
var renders_11745 = cljs.core.select_keys.call(null,fmap,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383),new cljs.core.Keyword(null,"componentFunction","componentFunction",825866104)], null));
var render_fun_11746 = cljs.core.first.call(null,cljs.core.vals.call(null,renders_11745));
if((cljs.core.count.call(null,renders_11745) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count.call(null,renders_11745))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_.call(null,render_fun_11746)){
} else {
throw (new Error(["Assert failed: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(["Expected something callable, not ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.pr_str.call(null,render_fun_11746))].join('')),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var name__$1 = (function (){var G__11744 = name;
switch (G__11744) {
case "":
...
var G__11748 = o;
(G__11748[cljs.core.name.call(null,k)] = v);
...
var name = (function (){var G__11749 = fiber;
var G__11749__$1 = (((G__11749 == null))?null:(G__11749["type"]));
...
var parent = (function (){var G__11750 = fiber;
if((G__11750 == null)){
return null;
} else {
return (G__11750["return"]);
}
})();
var path = (function (){var G__11751 = parent;
var G__11751__$1 = (((G__11751 == null))?null:reagent.impl.component.fiber_component_path.call(null,G__11751));
if((G__11751__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__11751__$1)," > "].join('');
}
})();
...
var temp__5455__auto__ = (function (){var or__3949__auto__ = (function (){var G__11753 = c;
if((G__11753 == null)){
return null;
} else {
return (G__11753["_reactInternalFiber"]);
}
})();
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
...
return G__11754._reactInternalFiber;
}
}
})();
...
var instance = (function (){var or__3949__auto__ = (function (){var G__11756 = c;
if((G__11756 == null)){
return null;
} else {
return (G__11756["_reactInternalInstance"]);
}
})();
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
} else {
var or__3949__auto____$1 = (function (){var G__11758 = c;
if((G__11758 == null)){
return null;
} else {
return G__11758._reactInternalInstance;
}
})();
...
var elem = (function (){var or__3949__auto__ = (function (){var G__11760 = instance;
if((G__11760 == null)){
return null;
} else {
return (G__11760["_currentElement"]);
}
})();
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
} else {
var G__11761 = instance;
if((G__11761 == null)){
return null;
} else {
return G__11761._currentElement;
}
}
})();
var name = (function (){var G__11762 = elem;
var G__11762__$1 = (((G__11762 == null))?null:(G__11762["type"]));
if((G__11762__$1 == null)){
return null;
} else {
return (G__11762__$1["displayName"]);
}
})();
var owner = (function (){var or__3949__auto__ = (function (){var G__11764 = elem;
if((G__11764 == null)){
return null;
} else {
return (G__11764["_owner"]);
}
})();
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
...
return G__11765._owner;
}
}
})();
var path = (function (){var G__11766 = owner;
var G__11766__$1 = (((G__11766 == null))?null:reagent.impl.component.component_path.call(null,G__11766));
if((G__11766__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__11766__$1)," > "].join('');
}
})();
var res = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(path),cljs.core.str.cljs$core$IFn$_invoke$arity$1(name)].join('');
if(cljs.core.empty_QMARK_.call(null,res)){
...
var G__11767 = c;
var G__11767__$1 = (((G__11767 == null))?null:G__11767.constructor);
if((G__11767__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name.call(null,G__11767__$1);
}
}
})();
