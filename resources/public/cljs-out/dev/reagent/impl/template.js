...
var G__11834 = o;
(G__11834[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
var G__11838 = o;
(G__11838[reagent.impl.template.cached_custom_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
var G__11843 = props;
var G__11843__$1 = ((((!((id == null))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.call(null,G__11843,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__11843);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__11843__$1,new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var old_class = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__11844){
...
var props = map__11845__$1;
var class$ = cljs.core.get.call(null,map__11845__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
if(cljs.core.coll_QMARK_.call(null,class$)){
return cljs.core.assoc.call(null,props,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.call(null," ",cljs.core.keep.call(null,((function (map__11845,map__11845__$1,props,class$){
return (function (c){
...
});})(map__11845,map__11845__$1,props,class$))
,class$)));
} else {
return props;
}
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__11847){
...
var on_write = cljs.core.get.call(null,map__11848__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return reagent.impl.batching.do_after_render.call(null,((function (node_value,map__11848,map__11848__$1,on_write){
return (function (){
return reagent.impl.template.input_component_set_value.call(null,component);
});})(node_value,map__11848,map__11848__$1,on_write))
);
} else {
...
var G__11851 = jsprops;
(G__11851["defaultValue"] = value);

(G__11851["onChange"] = ((function (G__11851,v,value,on_change){
return (function (p1__11850_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__11850_SHARP_);
});})(G__11851,v,value,on_change))
);
...
var vec__11854 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__11854,(0),null);
var id = cljs.core.nth.call(null,vec__11854,(1),null);
var class$ = cljs.core.nth.call(null,vec__11854,(2),null);
...
var jsprops = ({"argv": v});
var temp__5461__auto___11858 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__5461__auto___11858 == null)){
} else {
var key_11859 = temp__5461__auto___11858;
(jsprops["key"] = key_11859);
}
...
var temp__5461__auto___11860 = reagent.impl.template.key_from_vec.call(null,argv);
if((temp__5461__auto___11860 == null)){
} else {
var key_11861 = temp__5461__auto___11860;
reagent.impl.template.oset.call(null,jsprops,"key",key_11861);
}
...
var G__11862 = reagent.impl.template.__GT_NativeWrapper.call(null);
(G__11862["name"] = c);
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq11865){
var G__11866 = cljs.core.first.call(null,seq11865);
var seq11865__$1 = cljs.core.next.call(null,seq11865);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__11866,seq11865__$1);
});
...
break;
default:
var G__11872 = cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,cljs.core.with_meta.call(null,v,null),(0),cljs.core.subs.call(null,n,(pos + (1))))], null),cljs.core.meta.call(null,v));
v = G__11872;
continue;
...
var n__4408__auto___11874 = a.length;
var i_11875 = (0);
while(true){
if((i_11875 < n__4408__auto___11874)){
(a[i_11875] = reagent.impl.template.as_element.call(null,(a[i_11875])));
...
var a = cljs.core.into_array.call(null,s);
var n__4408__auto___11877 = a.length;
var i_11878 = (0);
while(true){
if((i_11878 < n__4408__auto___11877)){
var val_11879 = (a[i_11878]);
if(((cljs.core.vector_QMARK_.call(null,val_11879)) && ((reagent.impl.template.key_from_vec.call(null,val_11879) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_11878] = reagent.impl.template.as_element.call(null,val_11879));
...
var ctx = ({});
var vec__11881 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__11881,(0),null);
var derefed = cljs.core.nth.call(null,vec__11881,(1),null);
...
var G__11884 = (cljs.core.count.call(null,argv) - first_child);
switch (G__11884) {
case (0):
...
break;
default:
return reagent.impl.template.global$module$react.createElement.apply(null,cljs.core.reduce_kv.call(null,((function (G__11884){
