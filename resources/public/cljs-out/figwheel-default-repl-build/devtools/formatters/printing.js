...
var len__4531__auto___9874 = arguments.length;
var i__4532__auto___9875 = (0);
while(true){
if((i__4532__auto___9875 < len__4531__auto___9874)){
args__4534__auto__.push((arguments[i__4532__auto___9875]));

var G__9876 = (i__4532__auto___9875 + (1));
i__4532__auto___9875 = G__9876;
continue;
} else {
}
break;
...
/** @this {Function} */
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq9871){
...
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__9872,G__9873,seq9871__$2);
});
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__9877_SHARP_){
return !((cljs.core.meta.call(null,p1__9877_SHARP_) == null));
})))){
...
}catch (e9882){var _e__8715__auto__ = e9882;
return false;
}})();
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
...
}catch (e9884){var _e__8715__auto__ = e9884;
return false;
}}
})())){
...
var _STAR_current_state_STAR_9886 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__9887 = opts;
...
var markup_db = cljs.core.get.call(null,map__9887__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_9886;
}});
...
;
var temp__5455__auto___9891 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5455__auto___9891)){
var managed_print_level_9892 = temp__5455__auto___9891;
var _STAR_print_level_STAR_9890_9893 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_9892;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_9890_9893,managed_print_level_9892,temp__5455__auto___9891,writer,opts,job_fn){
return (function (p1__9889_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__9889_SHARP_,null);
});})(_STAR_print_level_STAR_9890_9893,managed_print_level_9892,temp__5455__auto___9891,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_9890_9893;
}} else {
job_fn.call(null);
}
