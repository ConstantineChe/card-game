...
var map__13745 = top_item;
var map__13745__$1 = ((((!((map__13745 == null)))?(((((map__13745.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__13745.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__13745):map__13745);
var file = cljs.core.get.call(null,map__13745__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__13745__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__13745__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e13744){var _e = e13744;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5455__auto___13747 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5455__auto___13747)){
var seen_errors_13748 = temp__5455__auto___13747;
if(cljs.core.truth_(seen_errors_13748.has(self))){
} else {
seen_errors_13748.add(self);

var temp__5457__auto___13749 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5457__auto___13749)){
var sense_13750 = temp__5457__auto___13749;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_13750)].join('');
} else {
}
}
} else {
