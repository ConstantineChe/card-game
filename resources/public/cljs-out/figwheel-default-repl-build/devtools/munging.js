...
var o8888 = temp__5455__auto__;
var temp__5455__auto____$1 = (o8888["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o8889 = temp__5455__auto____$1;
return (o8889["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__8708__auto__ = f;
return (o__8708__auto__["toString"]).call(o__8708__auto__);
} else {
return "";
}
}catch (e8890){var _ = e8890;
return "";
}});
...
try{var o__8708__auto___8892 = t;
(o__8708__auto___8892["cljs$lang$ctorPrWriter"]).call(o__8708__auto___8892,t,writer);
}catch (e8891){var __8893 = e8891;
}
...
var char_code = (function (){var o__8708__auto__ = (new String(char$));
return (o__8708__auto__["charCodeAt"]).call(o__8708__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__8708__auto__ = String;
return (o__8708__auto__["fromCharCode"]).call(o__8708__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__8894 = num_code;
switch (G__8894) {
case (1):
return (185);
...
var o__8708__auto__ = String;
return (o__8708__auto__["fromCharCode"]).call(o__8708__auto__,superscript_code);
});
/**
...
}catch (e8896){var _e__8715__auto__ = e8896;
return false;
}})())){
...
var vec__8897 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__8897,(0),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var o8900 = temp__5455__auto__;
var temp__5455__auto____$1 = (o8900["dependencies_"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o8901 = temp__5455__auto____$1;
return (o8901["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4531__auto___8908 = arguments.length;
var i__4532__auto___8909 = (0);
while(true){
if((i__4532__auto___8909 < len__4531__auto___8908)){
args__4534__auto__.push((arguments[i__4532__auto___8909]));

var G__8910 = (i__4532__auto___8909 + (1));
i__4532__auto___8909 = G__8910;
continue;
} else {
}
break;
...
var ns_detector = cljs.core.nth.call(null,vec__8905,(0),null);
...
var G__8911 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__8912 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__8911;
remaining_tokens = G__8912;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq8902){
var G__8903 = cljs.core.first.call(null,seq8902);
var seq8902__$1 = cljs.core.next.call(null,seq8902);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__8903,seq8902__$1);
});
...
var vec__8916 = cljs.core.split_with.call(null,(function (p1__8915_SHARP_){
return cljs.core.not_EQ_.call(null,p1__8915_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__8916,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__8916,(1),null);
...
var vec__8919 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__8919,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__8919,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__8922 = cljs.core.rest.call(null,remaining_tokens);
var G__8923 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__8922;
name_tokens = G__8923;
continue;
} else {
...
var vec__8926 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__8926,(0),null);
var arity = cljs.core.nth.call(null,vec__8926,(1),null);
var vec__8929 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__8929,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__8929,(1),null);
var vec__8932 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__8932,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__8932,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__8932,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__8932,(3),null);
...
var vec__8938 = result;
var munged_ns = cljs.core.nth.call(null,vec__8938,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__8938,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__8938,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__8938,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__8938,(4),null);
var arity = cljs.core.nth.call(null,vec__8938,(5),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__8942 = temp__5455__auto__;
var munged_name = cljs.core.nth.call(null,vec__8942,(0),null);
var args = cljs.core.nth.call(null,vec__8942,(1),null);
var vec__8945 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__8945,(0),null);
var name = cljs.core.nth.call(null,vec__8945,(1),null);
...
var G__8948 = (arity + (1));
var G__8949 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__8950){
var vec__8951 = p__8950;
var arity = cljs.core.nth.call(null,vec__8951,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__8951,(1),null);
...
return cljs.core.get.call(null,arities,p1__8954_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__8955_SHARP_);
...
var args__4534__auto__ = [];
var len__4531__auto___8962 = arguments.length;
var i__4532__auto___8963 = (0);
while(true){
if((i__4532__auto___8963 < len__4531__auto___8962)){
args__4534__auto__.push((arguments[i__4532__auto___8963]));

var G__8964 = (i__4532__auto___8963 + (1));
i__4532__auto___8963 = G__8964;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__8958){
var vec__8959 = p__8958;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__8959,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq8956){
var G__8957 = cljs.core.first.call(null,seq8956);
var seq8956__$1 = cljs.core.next.call(null,seq8956);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__8957,seq8956__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__8967__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__8967__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__8967__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__8967__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__8968 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__8968,(0),null);
var fn_name = cljs.core.nth.call(null,vec__8968,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__8968,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__8968,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__8968,(4),null);
var arity = cljs.core.nth.call(null,vec__8968,(5),null);
...
var o__8708__auto__ = f;
return (o__8708__auto__["getBasis"]).call(o__8708__auto__);
});
/**
...
}catch (e8972){var _e__8715__auto__ = e8972;
...
var G__8973 = (obj[cljs.core.first.call(null,path)]);
var G__8974 = cljs.core.rest.call(null,path);
obj = G__8973;
path = G__8974;
continue;
} else {
...
return (function (accum,p__8975){
var vec__8976 = p__8975;
var bit = cljs.core.nth.call(null,vec__8976,(0),null);
var protocol = cljs.core.nth.call(null,vec__8976,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__8979){
var vec__8980 = p__8979;
var ns = cljs.core.nth.call(null,vec__8980,(0),null);
var name = cljs.core.nth.call(null,vec__8980,(1),null);
var selector = cljs.core.nth.call(null,vec__8980,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__8985,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__8985,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__8985,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__8983_SHARP_){
return (obj[cljs.core.first.call(null,p1__8983_SHARP_)]);
});})(name,sorted_matches,vec__8985,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
